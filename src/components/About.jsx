...
export default function About() {
  return (
    <section id="about" className="py-24 px-4 relative overflow-hidden bg-gray-50 dark:bg-black">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-gradient-to-b from-white via-blue-50/30 to-white dark:from-black dark:via-blue-900/5 dark:to-black" />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white dark:bg-gradient-to-br dark:from-blue-500/5 dark:to-transparent p-8 rounded-3xl border border-blue-500/20 backdrop-blur-sm hover:border-blue-500/40 transition-all duration-300 shadow-lg">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white dark:bg-gradient-to-br dark:from-purple-500/5 dark:to-transparent p-8 rounded-3xl border border-purple-500/20 backdrop-blur-sm hover:border-purple-500/40 transition-all duration-300 shadow-lg">
              <div className="flex items-center gap-4 mb-6">
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white dark:bg-gradient-to-br dark:from-blue-500/5 dark:via-purple-500/5 dark:to-transparent p-8 rounded-3xl border border-blue-500/20 backdrop-blur-sm shadow-lg">
