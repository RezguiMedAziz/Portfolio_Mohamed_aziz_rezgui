        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              <a 
                href="#contact" 
                className="group relative px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl font-semibold overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/50 hover:scale-105"
              >
              ...
              <a 
                href="#projects" 
                className="px-8 py-4 border-2 border-blue-500 rounded-xl font-semibold hover:bg-blue-500/10 transition-all duration-300 backdrop-blur-sm"
              >
                Voir Mes Projets
              </a>
  ...
  src="/images/profile.jpg"  // ← Start with / (not ./public/)
                  ...
                  <div className="hidden w-full h-full items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-400 mt-2">Ajoutez votre photo ici</p>
                    </div>
                  </div>
                </div>
